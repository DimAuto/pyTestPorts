...
from serialTest import Test
from usb_test import USB
...
class Ui_Form(QtCore.QObject):
    ...
    def setupUi(self, Form):
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(30, 290,int( 81*m), int(20*m)))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.lineEdit_2.setStyleSheet('QLineEdit {font: 7pt "MS Shell Dlg 2";}')
        self.lineEdit_2.textChanged.connect(self.change_usb_path)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_8.setText(_translate("Form", "Drive Location"))
        self.list_coms()
        self.set_usb_path()
    ...
    def set_usb_path(self):
        self.lineEdit_2.setText(self.usb.path)
        QApplication.processEvents()

    def change_usb_path(self):
        self.usb_path=self.lineEdit_2.text()
